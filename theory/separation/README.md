# Theory notes: plain-text statements and proofs

Commit hashes mentioned in these notes refer to the development repository
(github.com/kunhailP/when-treatment-talks-back); this submission repository contains only the final
